...
class harden_windows_server (
  ...
  $ensure_log_on_as_a_batch_job_is_set_to_administrators = false #LEVEL 2
  $ensure_interactive_logon_number_of_previous_logons_to_cache_is_set_to_4_or_fewer_logons = false #LEVEL 2
  $ensure_network_access_do_not_allow_storage_of_password_and_credentials_for_authentication_is_set_to_enabled = false #LEVEL 2
  $ensure_mss_keepalivetime_how_often_keepalive_packets_are_sent_in_millisecondsis_set_to_enabled_300000_or_5_minutes = false #LEVEL 2
  $ensure_mss_performrouterdiscovery_allow_irdp_to_detect_and_configure_default_gateway_addresses_is_set_to_disabled = false #LEVEL 2
  $ensure_turn_on_mapper_io_lltdio_driver_is_set_to_disabled = false #LEVEL 2
  $ensure_turn_on_responder_rspndr_driver_is_set_to_disabled = false #LEVEL 2
  $ensure_turn_off_microsoft_peer_to_peer_networking_services_is_set_to_enabled = false #LEVEL 2
  $disable_ipv6_ensure_tcpip6_parameter_disabledcomponents_is_set_to_0xff255 = false #LEVEL 2
  $ensure_configuration_of_wireless_settings_using_windows_connect_now_is_set_to_disabled = false #LEVEL 2
  $ensure_prohibit_access_of_the_windows_connect_now_wizards_is_set_to_enabled = false #LEVEL 2
  #$ensure_turn_off_downloading_of_print_drivers_over_http_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_handwriting_personalization_data_sharing_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_handwriting_recognition_error_reporting_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_internet_connection_wizard_if_url_connection_is_referring_to_microsoftcom_is_set_to_enabled = false #LEVEL 2
  #$ensure_turn_off_internet_download_for_web_publishing_and_online_ordering_wizards_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_internet_file_association_service_is_set_to_enabled = false #LEVEL 2
  #$ensure_turn_off_printing_over_http_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_registration_if_url_connection_is_referring_to_microsoftcom_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_search_companion_content_file_updates_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_the_order_prints_picture_task_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_the_publish_to_web_task_for_files_and_folders_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_the_windows_messenger_customer_experience_improvement_program_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_windows_customer_experience_improvement_program_is_set_to_enabled = false #LEVEL 2
  $ensure_turn_off_windows_error_reporting_is_set_to_enabled = false #LEVEL 2
  #$ensure_require_a_password_when_a_computer_wakes_on_battery_is_set_to_enabled = false #LEVEL 2
  #$ensure_require_a_password_when_a_computer_wakes_plugged_in_is_set_to_enabled = false #LEVEL 2
  $ensure_restrict_unauthenticated_rpc_clients_is_set_to_enabled_authenticatied = false #LEVEL 2 MS ONLY
  $ensure_microsoft_support_diagnostic_tool_turn_on_msdt_interactive_communication_with_support_provider_is_set_to_disabled = false #LEVEL 2
  $ensure_enable_disable_perftrack_is_set_to_disabled = false #LEVEL 2
  $ensure_enable_windows_ntp_client_is_set_to_enabled = false #LEVEL 2
  $ensure_enable_windows_ntp_server_is_set_to_disabled = false #LEVEL 2 MS ONLY
  $ensure_turn_off_location_is_set_to_enabled = false #LEVEL 2
  $ensure_restrict_remote_desktop_services_users_to_a_single_remote_desktop_services_session_is_set_to_enabled = false #LEVEL 2
  $ensure_do_not_allow_com_port_redirection_is_set_to_enabled = false #LEVEL 2
  $ensure_do_not_allow_lpt_port_redirection_is_set_to_enabled = false #LEVEL 2
  $ensure_do_not_allow_supported_plug_and_play_device_redirection_is_set_to_enabled = false #LEVEL 2
  $ensure_set_time_limit_for_active_but_idle_remote_desktop_services_sessions_is_set_to_enabled_15_minutes_or_less = false #LEVEL 2
  $ensure_set_time_limit_for_disconnected_sessions_is_set_to_enabled_1_minute = false #LEVEL 2
  $ensure_join_microsoft_maps_is_set_to_disabled = false #LEVEL 2
  $ensure_prevent_internet_explorer_security_prompt_for_windows_installer_scripts_is_set_to_disabled = false #LEVEL 2
  $ensure_allow_remote_server_management_through_winrm_is_set_to_disabled = false #LEVEL 2
  $ensure_allow_remote_shell_access_is_set_to_disabled = false #LEVEL 2
  $ensure_turn_off_help_experience_improvement_program_is_set_to_enabled = false # LEVEL 2
  $ensure_prevent_codec_download_is_set_to_enabled = false #LEVEL 2
